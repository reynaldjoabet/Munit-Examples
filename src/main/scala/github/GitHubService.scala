...
class GitHubService(private val api: GitHubAPI) {
  ...
  /**
    ...
    *
    * @return
    *   List of repositories under given organization or a failed IO in case of an error
    */
  ...
  /**
    ...
    *
    * @return
    *   List of contributors with their contributions aggregated and sorted in descending order
    */
