...
/**
  * This solution is a basic implementation of concurrency problem of producer and consumer. This
  * solution is inefficient because producers runs faster than the consumer so the queue is
  * constantly growing.
  *
