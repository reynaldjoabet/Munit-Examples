...
/**
  * This solution is an implementation of concurrency problem of producer and consumer with bounded
  * buffer that is uncancellable. To terminate the execution use CTRL-C || CTRL+F2
  */
