...
object TraverseInParallelOver {
  ...
  /**
    ...
    *
    * @param list
    *   List of items over which to traverse
    * @param min
    *   Minimum amount of random sleep in milliseconds
    * @param max
    *   Maximum amount of random sleep in milliseconds
    * @param effect
    *   Effect to perform on each item
    *
    * @tparam A
    *   Type of the input items
    * @tparam B
